...
FROM
 paketrab rab
 LEFT JOIN temp_dataawal_paketmaterial pm ON pm.namapaketmaterial = rab.paketmat
 LEFT JOIN temp_dataawal_paketongkos po ON po.namapaketongkos = rab.paketongkos
 LEFT JOIN [bsbs].diameter dm ON dm.kodediameter = rab.diameter AND dm.aktif = 1
 ,(SELECT @id := 0) AS id